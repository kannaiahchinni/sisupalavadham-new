...
var SlokaDetailsComponent = (function () {
    ...
    SlokaDetailsComponent.prototype.showView = function (item) {
        ...
        item.show = !item.show;
        setTimeout(function () {
            var el = document.getElementById(item.slokaNo);
            el.scrollIntoView();
        }.bind(this, item.slokaNo), 2000);
    };
...
module.exports = "<div class=\"col-md-12 intro-text animated fadeIn\">\r\n    <div class=\"col-md-12 text-center\">\r\n        <h2> <span class=\"name\">शिशुपालवधम् - माघः (पूर्वार्धम्)  (ŚIŚUPĀLAVADHA OF MĀGHA (Pūrvārdha))</span></h2>\r\n    </div>\r\n    <div class=\"col-md-12 row background \">\r\n        <div class=\"col-lg-6 col-md-6 col-xs-12 col-sm-12 animated fadeInLeft text-center\">\r\n            <img src=\"../../assets/cover.jpg\" class=\"img-responsive img\">\r\n        </div>\r\n        <div class=\"col-lg-6 col-md-6 col-xs-12 col-sm-12 animated fadeInRight text\">\r\n            <p>\r\n                Welcome to the e-version of <code> Śiśupālavadha of Māgha</code>. The e-version captures salient features of understanding Sanskrit poetry viz., Padavibhāgaḥ, anvayaḥ, word analysis, syntactical relation, grammatical function, Kāraka analysis, Samāsa, Sandhi split, Alaṅkāra, Vrittam, Hindi and English translation, hyperlink to dictionaries, Amarakośa, Aṣṭādhyāyī, a pop-up feature on Vyākaraṇa aspects from Mallinātha's commentary etc. The Samāsa-vigraḥ is available as a tool-tip along with the picture showing the composition. By placing a cursor on the Samāsa, one gets this information. In addition to these, graphical representation of the Kāraka, as well as Samāsa analysis, is provided. The Kāraka analysis is available as a link to the sentence numbers.\r\n            </p>\r\n        </div>\r\n    </div>\r\n    <!-- <div class=\"col-md-12 text-center\">\r\n        <button class=\"btn btn-lg btn-danger\" ng-click=\"home()\">Śiśupālavadha of Māgha</button>\r\n    </div> -->\r\n\r\n</div>\r\n\r\n\r\n"
...
module.exports = "<div class=\"col-md-12\">\r\n    <ol class=\"breadcrumb\">\r\n        <li class=\"breadcrumb-item\"> <a routerLink=\"/home\" routerLinkActive=\"true\">Home</a></li>\r\n        <li class=\"breadcrumb-item active\">Preface</li>\r\n    </ol>\r\n\r\n\r\n\r\n    <div class=\"intro-text animated slideInDown\">\r\n\t\r\n\t\r\n\t<p>The method of teaching and learning of various studies, in the modern era, is emerging out in e-learning and e-teaching in a \r\n\tdifferent arena of knowledge systems and is creating a remarkable up gradation in the field of education. \r\n\tFor a language like Sanskrit which has vast literature in the form of published books and unpublished manuscripts,\r\n\telectronic data marks a way of extending the longevity of Sanskrit Literature for many more centuries to come. \r\n\tThus, it helps in transmitting its abundant knowledge it contains to the future generations.</p>\r\n\t\r\n\t<p>Samsaadhani, a Sanskrit computational toolkit is an e-platform for understanding Sanskrit texts following the Indian \r\n\tgrammatical tradition of Vyākaraṇa, Nyāya, and Mīmāṃsā. Use of this toolkit will facilitate the poetic usability for a linguist \r\n\tand also for a learner. With the help of this kit, an e-reader of <code>Śiśupālavadha of Māgha (Pūrvārdha)</code> is developed through \r\n\tcomputational linguistic approach, which serves the purpose of research, learning and also a tool of pedagogy.</p>\r\n\t\r\n\t<p>Śiśupālavadha of Māgha occupies a prominent role among the Kāvyas of Bṛhattrayī and Pañcachamahākāvyas of Sanskrit literature. \r\nSo, it would be essential for any ardent Sanskrit learner to read and understand this work.</p>\r\n\t<p> One can understand a Sanskrit verse in the following steps-</p>\r\n\r\n\t\t<ul>\r\n\t\t<li>(i) Padavibhāga </li>\r\n\t\t<li>(ii) Anvaya</li>\r\n\t\t<li>(iii) Word analysis </li>\r\n\t\t<li>(iv) Syntactical relation</li>\r\n\t\t<li> (v) Grammatical function</li>\r\n\t\t</ul>\r\n\r\n<p>The existing tools of Samsaadhani are used for generating the output of the features mentioned above of a verse. \r\nThese tools show up all possible tags. Apart from these, information on \r\n(i) Alaṅkāra (ii) vrittam* (iii) Hindi translation, and (iv) English translation is given manually to every verse. \r\nAnd also, a hyperlink to dictionaries, and Amarakośa are given. A pop-up feature on Vyākaraṇa aspects from Mallinātha's\r\n commentary is also added. The chronological index of Ślokas is given along with a search option. </p>\r\n\r\n<p>Thus, with the help of this tool-kit, an interested reader can have a complete analysis of any verse of\r\n <code>Śiśupālavadha of Māgha (Pūrvārdha)</code> at various levels.</p>\r\n\r\n<p><code>Mallinātha's sarvaṅkaṣā commentary and Chowkāmbha Publications are taken as reliable sources for review and translation. For English translation Cantos I-IV are taken from Chowkhamba Krishnadas Academy and Cantos VI-X are translated by Dr. R. Anupama.</code></p>\r\n\r\n<p>Thus this work with Hindi and English translation is available in e-version which allows a reader to navigate through all the steps as mentioned above and understand the text in a better way.</p>\r\n\r\n<p>In canto-II, information of chandas instead of vrittam is given.</p>\r\n\t\r\n\t\r\n\r\n    \r\n    </div>\r\n\r\n</div>"
